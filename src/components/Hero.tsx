        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="md:w-1/2 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button className="bg-transparent text-oralia hover:text-oralia-light border border-oralia hover:border-oralia-light px-8 py-6 text-lg">
                View Demo
              </Button>
            </div>
          </div>
            ...
            <div className="w-full aspect-square max-w-md mx-auto relative animate-float">
              ...
              <div className="relative bg-dark-card rounded-3xl shadow-xl overflow-hidden border border-gray-800 p-8">
                ...
                <div className="space-y-4">
                  <div className="bg-dark-accent p-4 rounded-xl max-w-[80%] animate-pulse-slow">
